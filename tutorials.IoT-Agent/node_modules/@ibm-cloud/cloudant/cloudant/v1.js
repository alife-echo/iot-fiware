...
var CloudantV1 = /** @class */ (function (_super) {
     ...
     */
    CloudantV1.prototype.postPartitionExplain = function (params) {
        var _params = __assign({}, params);
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postPartitionExplain');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postIndex = function (params) {
        ...
        var _validParams = ['db', 'index', 'ddoc', 'name', 'partitioned', 'type', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    CloudantV1._logger = (0, ibm_cloud_sdk_core_1.getNewLogger)('CloudantV1');
...
(function (CloudantV1) {
    ...
    var PostPartitionExplainConstants;
